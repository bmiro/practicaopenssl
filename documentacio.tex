...
%La seguretat en les comunicacions es un tema molt important i que moltes
%vegades es deixa de banda. L'intercanvi de dades a la xarxa es molt important
%que sigui xifrat i que es sapiga que realment s'envia la informació al lloc
%correcte. Per aconseguir això tenim el protocol SSL (Secure Sockets Layer), que
...
%En aquest document veurem el procés a seguir per instalar un certificat SSL a
%un servidor Apache del paquet XAMPP. Per això, començarem vegent com es
%configura el paquet XAMPP i l'OpenSSL, com es genera la clau privada i el
